...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/kegiatan/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/kegiatan/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/kegiatan/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/kegiatan/' + rowData.id)
